...
---@class CityWorkUICostItemTableViewProCell:BaseTableViewProCell
local CityWorkUICostItemTableViewProCell = class('CityWorkUICostItemTableViewProCell', BaseTableViewProCell)

function CityWorkUICostItemTableViewProCell:OnCreate()
...
---@param data CityWorkUICostItemTableViewProCellData
function CityWorkUICostItemTableViewProCell:OnFeedData(data)
    self.data = data
...
function CityWorkUICostItemTableViewProCell:OnClickBtnAdd()
...
function CityWorkUICostItemTableViewProCell:OnClickShowTips()
    if not self.data then return end
...
return CityWorkUICostItemTableViewProCell