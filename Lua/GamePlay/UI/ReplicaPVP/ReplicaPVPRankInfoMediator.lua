...
---@class ReplicaPVPRankInfoMediatorParameter

---@class ReplicaPVPRankInfoMediator:BaseUIMediator
---@field new fun():ReplicaPVPRankInfoMediator
---@field super BaseUIMediator
local ReplicaPVPRankInfoMediator = class('ReplicaPVPRankInfoMediator', BaseUIMediator)

function ReplicaPVPRankInfoMediator:OnCreate(param)
    self.tableTabs = self:Table('p_table_tab')
    ...
    -- 段位奖励页面
    self.panelReward = self:GameObject('p_lv_reward')
    self.txtReward = self:Text('p_text_reward', 'se_pvp_levelmessage_levelup')
    self.tableRewards = self:TableViewPro('p_table_reward')
end

---@param data ReplicaPVPRankInfoMediatorParameter
function ReplicaPVPRankInfoMediator:OnOpened(param)
...
function ReplicaPVPRankInfoMediator:OnClose(param)

end

function ReplicaPVPRankInfoMediator:OnShow(param)

end

function ReplicaPVPRankInfoMediator:OnHide(param)

end

function ReplicaPVPRankInfoMediator:OnTabInfoClicked()
...
function ReplicaPVPRankInfoMediator:OnTabRewardClicked()
...
function ReplicaPVPRankInfoMediator:OnTabRuleClicked()
    self.panelInfo:SetActive(false)
    self.panelReward:SetActive(false)
...
function ReplicaPVPRankInfoMediator:UpdateTabInfo()
...
function ReplicaPVPRankInfoMediator:UpdateTabReward()
...
function ReplicaPVPRankInfoMediator:UpdateTabRule()
    -- do nothing
end

return ReplicaPVPRankInfoMediator