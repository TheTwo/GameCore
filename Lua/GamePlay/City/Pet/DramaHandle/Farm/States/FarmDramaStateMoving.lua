...
---@class FarmDramaStateMoving:FarmDramaStateBase
local FarmDramaStateMoving = class("FarmDramaStateMoving", FarmDramaStateBase)

function FarmDramaStateMoving:Enter()
    self.checkMoving = true
    self.handle:SetIgnoreStrictMovingSpeedUp(true)
    self.handle.petUnit:PlayMove()
end

function FarmDramaStateMoving:Exit()
...
function FarmDramaStateMoving:Tick()
