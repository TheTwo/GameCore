...
namespace XLua.LuaDLL
{
    ...
    public partial class Lua
	{
        ...
        public static int luaL_error_exception(IntPtr L, Exception e)
        {
	        xlua_csharp_error(L);
		...
		{
			public fixed sbyte Bytes[LUAI_MAXSHORTLEN];
			public int Length;
			public int HashCode;
		}

		public unsafe class FixedStringEquality : IEqualityComparer<FixedString>
		{
			public bool Equals(FixedString x, FixedString y)
			{
			...
			public int GetHashCode(FixedString obj)
			{
				if (obj.HashCode != 0)
					return obj.HashCode;
				...
				{
					hash = hash * 33 + obj.Bytes[i];					
				}

				obj.HashCode = (int)hash;
				return obj.HashCode;
			}
		}

		private static Dictionary<FixedString, string> dict = new(new FixedStringEquality());
...
#else
				if (strlen.ToInt32() <= LUAI_MAXSHORTLEN)
				{
					var fixedStr = new FixedString
					{
						Length = strlen.ToInt32()
					};
					
					Buffer.MemoryCopy(str.ToPointer(), fixedStr.Bytes, LUAI_MAXSHORTLEN * sizeof(sbyte), strlen.ToInt32());
					if (dict.TryGetValue(fixedStr, out var retString))
						return retString;

					retString = new string(fixedStr.Bytes, 0, fixedStr.Length, Encoding.UTF8);
					dict[fixedStr] = retString;
					return retString;
				}
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe void xlua_pushlstring(IntPtr L, byte* str, int size);

        public static unsafe void xlua_pushlstringRaw(IntPtr L, byte* str, int size)
        {
	        xlua_pushlstring(L, str, size);
        }
        ...
        public static unsafe ReadOnlySpan<byte> xlua_toreadonlyspanbytes(IntPtr L, int index)
        {
	        if (lua_type(L, index) == LuaTypes.LUA_TSTRING)
	        {
		        ...
		        if (str != IntPtr.Zero)
		        {
			        return new ReadOnlySpan<byte>(str.ToPointer(), strLen.ToInt32());
		        }
	        }
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe int xluaL_loadbuffer(IntPtr L, IntPtr bytesBuff, int size, string name);
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void lua_ssr_manual_crush(IntPtr L);

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void lua_ssr_manual_stackoverflow(IntPtr L);

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]

        public static extern void luaopen_ssrbitarray(IntPtr L);
        
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void luaopen_ssrstreamhandle(IntPtr L);
        
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void luaopen_ssrbytearray(IntPtr L);

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void lua_ssr_enable_profiler(IntPtr L, int enable);
        
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void luaenable_tracegc(int enable);

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void luaopen_ssrmemlib(IntPtr L);
        

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void luaopen_ssrstrex(IntPtr L);
